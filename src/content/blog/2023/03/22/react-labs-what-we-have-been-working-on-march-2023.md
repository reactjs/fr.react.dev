...
- Un composant d'onglets pourrait préserver l'état d'onglets masqués, pour que lorsque l'utilisateur rebascule dessus, ils ne perdent pas leur progression.
...
En complément de ce bulletin, notre équipe est récemment apparaue dans des podcasts communautaires et des *livestreams* pour parler de notre travail et répondre à vos questions.
...
* [Dan Abramov](https://twitter.com/dan_abramov) et [Joe Savona](https://twitter.com/en_JS) étaient les invités du [podcast JSParty](https://jsparty.fm/267) pour parler de leur vision de l'avenir de React.
