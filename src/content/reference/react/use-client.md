...
Ajoutez `'use client';` tout en haut d'un fichier pour indiquer que de fichier (ainsi que tout composant enfant qu'il utilise) s'exécute coté client, indépendamment des endroits qui l'importent.
