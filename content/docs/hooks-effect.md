...
L’Effect Hook traite ces deux cas en une seule API.
...
Félicitations ! Une bien longue page, mais avec un peu de chance la plupart de vos questions à propos des effets ont finalement pu trouver une réponse. Vous avez appris à la fois le State Hook et l’Effect Hook, vous ouvrant *beaucoup* de possibilités en les combinant. Ils couvrent la majorité des cas d’usage pour les classes -- et sinon, peut-être trouverez-vous les [Hooks supplémentaires](/docs/hooks-reference.html) bien utiles.
