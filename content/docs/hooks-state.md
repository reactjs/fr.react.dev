...
Dans une fonction composant, nous pouvons pas assigner ou lire `this.state` puisqu'il n'y a pas de `this`. Au lieu de ça, nous appellerons directement le Hook `useState` dans notre composant :
