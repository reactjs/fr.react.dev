...
Sur le long terme, nous comptons que Suspense devienne le moyen principal de lire des données asynchrone depuis des composants, et ce d’où que ces données viennent.
